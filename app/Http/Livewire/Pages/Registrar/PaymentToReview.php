...
class PaymentToReview extends Component
{
    ...
    {
        return view('livewire.pages.registrar.payment-to-review',[
            'requests'=>Request::where('status','payment-to-review')
    ...
    {
        return redirect()->route('registrar.request.details',['id'=>$id,'action'=>'payment-to-review']);
    }
}