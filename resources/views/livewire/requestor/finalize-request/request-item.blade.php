    <li class="flex px-4 py-6 sm:px-6">
        ...
        <div class="flex flex-col flex-1 ml-6">
                ...
                <div class="flex-1 min-w-0">
                    <h4 class="text-sm">
                        <a href="#"
                            ...
                            {{ $request_document->campusDocument->document->name }} </a>
                    </h4>
                    <p class="mt-1 text-sm text-gray-500">
                        Copies : {{ $copies }}
                    </p>
                    <p class="mt-1 text-sm text-gray-500">
                        {{ $withAuth == '1' ? 'With Authentication' : 'Without Authentication' }}
                    </p>
                </div>
            ...
            <div class="flex items-end justify-end flex-1 pt-2">
                <div class="ml-4">
                    <div class="space-y-2 sm:flex sm:space-x-2 sm:space-y-0">
                        <x-native-select wire:model="copies"
                            label="Copies">
                            @for ($i = 1; $i <= 20; $i++)
                                <option value="{{ $i }}">{{ $i }}</option>
                            @endfor
                        </x-native-select>
                        <x-native-select wire:model="withAuth"
