<div class="flex items-center justify-center">
    ...
    <div class="w-full pt-10 mx-auto mb-10 max-w-7xl">
        <div class="grid justify-center mx-auto mb-3">
            <svg data-name="Layer 1"
                ...
                <path
                    ...
                    transform="translate(-241.16498 -177.71861)"
                    fill="#009a3c" />
                <polygon points="334.034 511.488 323.884 515.825 302.324 478.74 317.305 472.338 334.034 511.488"
                    fill="#ffb6b6" />
                <path
                    ...
                    transform="translate(-241.16498 -177.71861)"
                    fill="#2f2e41" />
                <polygon points="174.924 524.067 163.9 523.528 160.731 480.749 177.003 481.544 174.924 524.067"
                    fill="#ffb6b6" />
                <path
            ...
            <h1 class="mt-3 text-lg font-semibold text-gray-600 uppercase">
            ...
            <form>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        <div>
                            @if ($valid_id)
                                <span class="font-semibold text-green-600">File Uploaded</span>
                            @endif
                        </div>
                        <x-input type="file"
                            wire:model="valid_id"
                        ...
                        <div>
                            <span wire:loading
                                ...
                                class="font-semibold">Uploading. . . </span>
                        </div>
                    </div>
                </div>
            </form>
            <x-slot name="footer">
                <div class="flex justify-end">
                    <x-button type="button"
                        wire:click.prevent="addInformation"
                        spinner="addInformation"
                        info>
                        Submit
                    </x-button>
                </div>
