...
@section('main')
    <div class="pt-6 pb-20">
        ...
        <div class="px-4 mt-10 sm:px-6 md:px-0">
            <div>
                <div class="grid grid-cols-1 gap-5 mt-2 sm:grid-cols-2 lg:grid-cols-3">
                    <div class="relative overflow-hidden border rounded-lg bg-gradient-to-tr from-red-500 to-yellow-300">
                        ...
                        <div class="z-20 p-5">
                            <div class="flex items-center">
                                <div class="flex-1 w-0 ml-2">
                                    <dl>
                                        <dt class="text-sm font-medium truncate text-gray-50">
                                            Users
                                        </dt>
                                        <dd>
                    ...
                    <div class="relative overflow-hidden border rounded-lg bg-gradient-to-tr from-purple-400 to-blue-400 ">
                        <div class="absolute right-0 ">
                            <svg data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="relative overflow-hidden border rounded-lg bg-gradient-to-tr from-green-600 to-green-300">
                        <div class="absolute right-0">
                            <svg data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                class="z-10 mt-2 mr-1 h-28"
                    ...
                    <div class="relative overflow-hidden border rounded-lg bg-gradient-to-tr from-blue-700 to-blue-50">
                        <div class="absolute right-0">
                            <svg data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                class="z-10 mt-2 mr-1 h-28"
                    ...
                    <div class="relative overflow-hidden border rounded-lg bg-gradient-to-tr from-red-800 to-purple-400">
                        <div class="absolute right-0">
                            <svg data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                class="z-10 mt-2 mr-1 h-28"
